...
cells = [
    {
        ...
        "source": [
            ...
            "\n",
            "Put **images and masks at 2048×2048** (same size, do not pre-resize to 512). "
            "Training uses random **1024×1024** crops; final metrics use sliding-window inference on the full 2048 tile.\n",
            "\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "    mask = tf.gather(LUT_TF, tf.clip_by_value(tf.cast(mask[..., 0], tf.int32), 0, 255))\n",
