...
cells = [
    {
        ...
        "source": [
            ...
            "\n",
            "Improved facade segmentation (RGB, ASPP, boundary loss, frozen encoder BN, TTA).\n",
            "\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "    model.compile(optimizer=make_optimizer(lr), loss=combined_loss, metrics=train_metrics())\n",
            "\n",
            "\n",
